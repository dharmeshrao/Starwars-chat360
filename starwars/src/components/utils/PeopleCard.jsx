  ...
  return (
    <div className="sm:w-4/5 w-full p-4 bg-white m-auto rounded-xl drop-shadow-lg flex flex-col gap-2">
      <div className="flex justify-around text-center p-4 bg-purple-100 bg-opacity-40 rounded-xl">
        <div className="w-1/3">
          <h4 className="text-purple-600 sm:font-semibold text-sm sm:text-lg">Name</h4>
          <p className="text-black sm:text-2xl sm:font-bold">{name || ""}</p>
        </div>
        <div className="w-1/3">
          <h4 className="text-purple-600 sm:font-semibold text-sm sm:text-lg">Birth</h4>
          <p className="text-black sm:text-2xl sm:font-bold">{birth || ""}</p>
        </div>
        <div className="w-1/3">
          <h4 className="text-purple-600 sm:font-semibold text-sm sm:text-lg">Gender</h4>
      ...
      {height ? (
        <div className="flex justify-around text-center p-4 bg-purple-100 bg-opacity-40 rounded-xl">
          <div className="w-1/3">
            <h4 className="text-purple-600 sm:font-semibold text-sm sm:text-lg">Height</h4>
            <p className="text-black sm:text-2xl font-bold">{height || ""}</p>
          </div>
          <div className="w-1/3">
            <h4 className="text-purple-600 sm:font-semibold text-sm sm:text-lg">Mass</h4>
          ...
          <div className="w-1/3">
            ...
            <p className="text-black sm:sm:text-2xl font-bold">{hair_color || ""}</p>
          </div>
        </div>
      ) : (
        ""
      ...
      {films ? (
        peopleFilm.length > 0 ? (
          <div className="bg-purple-100 bg-opacity-30 rounded-xl flex p-4 items-center">
            <h2 className="font-semibold sm:text-xl mr-9 text-black">Films: </h2>
      ...
      {vehicles ? (
        peopleVehicles.length > 0 ? (
          <div className="bg-purple-100 bg-opacity-30 rounded-xl flex p-4 items-center">
            <h2 className="font-semibold sm:text-xl mr-2 text-black">Vehicles:</h2>
            <div className="flex flex-wrap gap-y-2">
